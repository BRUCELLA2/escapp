...
/**
 * This class allow to map row of {@link java.sql.ResultSet} to a Map of {@link Comment} business object with the login of the user who write the comment.
 * 
 * @author BRUCELLA
 */
public class CommentWithLoginRM  implements RowMapper<Pair<Comment, String>> {
	...
	public Pair<Comment, String> mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        Pair<Comment, String> vCommentWithLogin = new MutablePair<Comment, String>(vComment, vLogin);
        
        return vCommentWithLogin;
	}
}
