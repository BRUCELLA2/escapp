...
public interface TopoManager {
	...
	/**
	 * Get the list of {@link Topo} that match to search criteria.
	 * If no search criteria are provided, the list of all {@link Topo} is returned.
	 * 
	 * @param pTopoSearch the search criteria {@link TopoSearch}
	 * 
	 * @return the list of {@link Topo} that match to search criteria or the list of all {@link Topo} if no search criteria are provided
	 * 
	 * @throws TechnicalException - wraps technical exception caused during data access.
	 * @throws NotFoundException - This exception is throws if no {@link Topo} is found.
	 * @throws FunctionalException - This exception is throws if the data of the search criteria {@link TopoSearch} are not valide.
	 */
	...
	/**
	 * Change the borrowable property of the {@link Topo}.
	 * The borrowable property of the Topo give in parameter will be updated.
	 * 
	 ...
	 * 
	 * @throws TechnicalException - wraps technical exception caused during data access.
	 * @throws FunctionalException - This exception is throws if the borrowable property is null
	 * 							   - This exception is throws if the {@link User} is null
	 * 							   - This exception is throws if the {@link Topo} is null
	 * 							   - This exception is throws if the {@link User} is not the owner of the {@link Topo}
	 * @throws NotFoundException - This exception is throws if the {@link Topo} is not found.
	 */
	 ...
	 * 
	 * @return a {@link Topo} modified with the new values.
	 * 			Borrower property will be updated with the {@link User} borrower in the {@link Topo} returned.
	 * 			End date of borrow will be updated with the number of days of borrow in the {@link Topo} returned.
	 * 
	 * @throws TechnicalException - wraps technical exception caused during data access.
	 * @throws FunctionalException - This exception is throws if the {@link Topo} is null
	 * 							   - This exception is throws if the {@link User} is null
	 * 							   - This exception is throws if the number of days is null
	 * 							   - This exception is throws if the number of days is more than 14.
	 * 							   - This exception is throws if the number of days is less than 1.
	 * 							   - This exception is throws if the {@link Topo} is already borrowed by someone. 
	 * @throws NotFoundException - This exception is throws if the {@link Topo} is not found.
	 */
	...
	/**
	 * Validate and add the {@link Topo} to data store.
	 * The id will be added to the {@link Topo} give in parameter.
	 * 
	 * @param pTopo the {@link Topo} to add.
	 * 
	 * @throws TechnicalException - wraps technical exception caused during data access.
	 * @throws FunctionalException - This exception is throws if the {@link Topo} pTopo is null.
	 * 							   - This exception is throws if the data in the {@link Topo} are not valid.
	 */
	...
	/**
	 * Delete the {@link Topo} with the specified id.
	 * Delete also the pdf file and all the {@link fr.brucella.form.escapp.model.beans.comment.Comment} associated to the {@link Topo}  
	 * 
