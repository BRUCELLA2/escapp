...
public interface LengthManager {
	...
	/**
	 * Validate and add the {@link Length} to data store.
	 * The id will be added to the {@link Length} give in parameter.
	 * 
	 * @param pLength the {@link Length} to add.
	 * 
	 * @throws TechnicalException - wraps technical exception caused during data access.
	 * @throws FunctionalException - This exception is throws if the {@link Length} is null.
	 * 							   - This exception is throws if the data in the {@link Length} are not valid.
	 */
