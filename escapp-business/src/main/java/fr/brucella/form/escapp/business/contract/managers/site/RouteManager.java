...
public interface RouteManager {
	 ...
	 * 
	 * @throws TechnicalException - wraps technical exception caused during data access.
	 * @throws FunctionalException - This exception is throws if the {@link Route} is null.
	 * 							   - This exception is throws if the data in the {@link Route} are not valide.
	 * @throws NotFoundException - This exception is throws if the {@link Route} is not found.
	 */
	public void modifyRoute(Route pRoute) throws TechnicalException, FunctionalException, NotFoundException;
	
	/**
	 * Validate and add the {@link Route} to data store.
	 * The id will be added to the {@link Route} give in parameter.
	 * 
