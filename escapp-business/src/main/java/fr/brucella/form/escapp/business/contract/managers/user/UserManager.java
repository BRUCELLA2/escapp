...
public interface UserManager {
	...
	/**
	 * Get a {@link User} authentified by login and password. 
	 * If login and password don't match, this method throws a not found exception. 
	 * If login and password match, this method return the {@link User}
	 * 
	 * @param pUserLogin the login of the {@link User}
	 ...
	 * @throws TechnicalException - wraps technical exception caused during data access.
	 * @throws FunctionalException - This exception is throws if the login is null or empty.
	 * 							   - This exception is throws if the password is null or empty.
	 * 							   - This exception is throws if the password and the login are null or empty.
	 * @throws NotFoundException - This exception is throws if the {@link User} is not found.
	 * 							 - This exception is throws if the login and password don't match.
	 */
	...
	/**
	 * Validate and add the {@link User} to data store. 
	 * The password property of the {@link User} need to be raw password. This raw password will be encrypted.
	 * A new {@link User} with an user id and password encrypted will be returned by this method.
	 * 
	 ...
	 * 
	 * @throws TechnicalException - wraps technical exception caused during data access.
	 * @throws FunctionalException - This exception is throws if the {@link User} is null.
	 * 							   - This exception is throws if the password of the {@link User} is not null or empty.
	 * 							   - This exception is throws if the data in the {@link User} are not valid.
	 */
	public User addUser(User pUser) throws TechnicalException, FunctionalException;
	
	/**
	 * Modify the password of the {@link User} give in parameter.
	 * The new password need to be raw password. This new password will be encrypted and add to the {@link User}
	 * 
	 ...
	 * @throws TechnicalException - wraps technical exception caused during data access. 
	 * @throws FunctionalException - This exception is throws if the {@link User} is null.
	 * 							   - This exception is throws if the new password is null.
	 * 							   - This exception is throws if the data in the {@link User} are not valid.
	 * @throws NotFoundException - This exception is throws if the {@link User} is not found in data store.
	 */
	 ...
	 * @param pUserId {@link Integer} id of the {@link User}
	 * 
	 * @return the list of {@link RoleUser} of the {@link User} with the specified id.
	 * 			null if the {@link User} has no role.
	 * 
	 * @throws TechnicalException - wraps technical exception caused during data access. 
	 * @throws FunctionalException - This exception is throws if the user id is null.
	 */
