			...
			<div class="row">
				<div class="col-xs-6 col-xs-offset-3">
					<div class="panel panel-primary">
						<div class="panel-heading text-center">Création du compte
							utilisateur</div>
								...
								<form class="form-horizontal" method="post" action="register">
									...
									<div class="form-group">
										<label for="login">Identifiant :</label> <input type="text"
											...
											value='<s:property value="login"/>'>
										<div class="has-error">
											<span class="help-block"><s:fielderror
													fieldName="login" /></span>
										</div>
									</div>
									...
									<div class="form-group">
										<label for="confPwd">Confirmation :</label> <input
											type="password" class="form-control" id="confPwd"
											name="confPwd">
										<div class="has-error">
											<span class="help-block"><s:fielderror
													fieldName="confPwd" /></span>
										</div>
									</div>
