...
<div class="container">
	...
	<div class="panel panel-primary">
		<div class="panel-heading"><h3 class="panel-title">Recherche de topos</h3></div>
		<div class="panel-body">
			
			<form class="form-horizontal" method="post" action="searching_topo">
				<div class="form-group">
					<label class="control-label col-sm-5" for="departmentTopo">Département (sur 3 caractères) :</label>
					<input class="col-sm-1" type="text" class="form-control" id="departmentTopo" name="departmentTopo" maxlength="3" placeholder="xxx">
				</div>
				<div class="form-group">
					<label class="control-label col-sm-5" for="municipalityTopo">Commune :</label>
					<input class="col-sm-4" type="text" class="form-control" id="municipalityTopo" name="municipalityTopo" maxlength="100" placeholder="Nom de la ville">
				</div>
				<div class="form-group">
					<label class="control-label col-sm-5" for="available">Disponible : </label>
	...
	<div class="panel panel-primary">
		<div class="panel-heading"><h3 class="panel-title">Liste des topos recherchés :</h3></div>
		<div class="panel-body">
			<table class="table table-bordered table-striped table-condensed">
				...
				<s:iterator value="toposList">
					<tr>
						...
						<td><fmt:parseDate value="${endDateBorrow}" pattern="yyyy-MM-dd" var="parsedDate" type="date" />
							<fmt:formatDate value="${parsedDate}" var="stdDatum" type="date" pattern="dd/MM/yyyy" />
							<c:out value="${stdDatum}"></c:out>
						</td>
						<td><s:a class="btn btn-primary btn-block" action="topo_details"><s:param name="id" value="id" /><span class="glyphicon glyphicon-search"></span>
								Voir le détail
							</s:a>
						</td>
					</tr>
