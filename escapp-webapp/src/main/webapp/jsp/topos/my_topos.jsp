	...
	<div class="container">
		...
		<header class="page-header text-center">
      	...
      	<div class="panel panel-primary">
			<div class="panel-heading"><h4>Liste de mes topos :</h4></div>
			<div class="panel-body">
				...
				<p><s:a action="add_topo">Ajouter un topo</s:a></p>
			</div>
		</div>
		
		<div class="panel panel-primary">
			<div class="panel-heading"><h4>Liste des topos empruntés :</h4></div>
			<div class="panel-body">
