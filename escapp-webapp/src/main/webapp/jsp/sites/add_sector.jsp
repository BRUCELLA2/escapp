		...
		<div class="row">
    		<div class="col-xs-8 col-xs-offset-2">
		      	<div class="panel panel-primary">
		      		<div class="panel-heading text-center"><h2>Ajouter un secteur :</h2></div>
					      	...
					      	<form class="form-horizontal" method="post" action="add_sector">
					      		<div class="form-group row">
						      		<div class="col-xs-12">	      			
						      			...
						      			<input type="text" class="form-control" id="sectorName" name="sectorName" value='<s:property value="sectorName"/>'>
						      			<div class="has-error"><span class="help-block"><s:fielderror fieldName="sectorName"/></span></div> 
						      		</div>
					      		</div>
					      		...
					      		<div class="form-group row">
						      		<div class="col-xs-12">	
						      			...
						      			<textarea class="form-control" rows="5" name="sectorDescription" id="sectorDescription" placeholder="Saisissez la description du secteur."><s:property value="sectorDescription"/></textarea>
						      			<div class="has-error"><span class="help-block"><s:fielderror fieldName="sectorDescription"/></span></div>
						      		</div>
					      		</div>
