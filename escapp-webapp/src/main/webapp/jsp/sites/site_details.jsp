	...
	<div class="container">
		...
		<div class="panel-group">
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<s:a data-toggle="collapse" href="#collapseCommentSite">Commentaires <span
							class="badge"><s:property value="nbCommentsSite" /></span>
					</s:a>
					...
					<div class="panel panel-default">
						<div id="collapseCommentSite" class="panel-collapse collapse">
							<div class="panel-body">
								...
								<s:actionmessage />
								<s:iterator value="commentsSiteList" status="statusComSiteList"
									var="commentSite">
									<div class="panel panel-info">
										<div class="panel-heading">
											<p>
												Commentaire
												<s:property value="#statusComSiteList.count" />
												-
												<s:property value="#commentSite.value" />
											</p>
										</div>
										<div class="panel-body">
											<p>
												<s:property value="#commentSite.key.text" />
											</p>
										</div>
									</div>
								</s:iterator>
								...
								<s:if test="#session.user">
									<form action="comment_site">
										<div class="form-group">
											...
											<textarea class="form-control" rows="5" name="commentSite"
												id="commentSite"
												placeholder="Saisissez votre commentaire ici."></textarea>
											<div class="has-error">
												<span class="help-block"><s:fielderror
														fieldName="commentSite" /></span>
											</div>
											<input type="hidden" name="siteId" id="siteId"
												value="<s:property value='site.id'/>" />
										</div>
				...
				<s:iterator value="sectorsList" status="statusSector" var="sector">
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4>Description du secteur</h4>
								</div>
								<div class="panel-body">
									<p>
										<s:property value="#sector.description" />
									</p>
								</div>
								...
								<s:iterator value="nbCommentsSectorsList" var="nbCommentsSector">
									<s:if test="#nbCommentsSector.key == #idSector">
										<s:set var="nbCommentsSec">
											<s:property value="#nbCommentsSector.value" />
										</s:set>
									</s:if>
								</s:iterator>

								<div class="panel-body">
									<s:a data-toggle="collapse"
										href="#collapseCommentSector%{#statusSector.count}">Commentaires <span
											class="badge"><s:property value="#nbCommentsSec" /></span>
									</s:a>
								</div>
								...
								<div class="panel-group">
									<div class="panel panel-default">
										<div
											id="collapseCommentSector<s:property value='#statusSector.count'/>"
											...
											<div class="panel-body">
												...
												<s:iterator value="commentsSectorList" var="commentSector">
													<s:if
														test="#idSector == #commentSector.key.idCommentTarget">
														<s:set var="counterCommSectorList"
															value="%{#counterCommSectorList+1}" />
														<div class="panel panel-info">
															<div class="panel-heading">
																<p>
																	Commentaire
																	<s:property value="#counterCommSectorList" />
																	-
																	<s:property value="#commentSector.value" />
																</p>
															</div>
															<div class="panel-body">
																<p>
																	<s:property value="#commentSector.key.text" />
																</p>
															</div>
														</div>
													</s:if>
												...
												<s:if test="#session.user">
													<form action="comment_sector">
														...
														<div class="form-group">
															<label for="commentSector">Ajouter un commentaire
																:</label>
															<textarea class="form-control" rows="5"
																name="commentSector" id="commentSector"
																placeholder="Saisissez votre commentaire ici."></textarea>
															<div class="has-error">
																<span class="help-block"><s:fielderror
																		fieldName="commentSector" /></span>
															</div>
															<input type="hidden" name="sectorId" id="sectorId"
																value="<s:property value='#sector.id'/>" /> <input
																type="hidden" name="siteId" id="siteId"
																value="<s:property value='site.id'/>" />
														</div>
														<button type="submit" class="btn btn-default">Envoyer</button>
													</form>
										...
										<s:iterator value="routesList" var="route">
											<s:if test="#route.sectorId == #sector.id">
												<li><s:a action="route_details">
														...
														<s:property value="#route.name" /> - Cotation : <s:property
															value="#route.grade" />
													</s:a></li>
											</s:if>
										</s:iterator>
