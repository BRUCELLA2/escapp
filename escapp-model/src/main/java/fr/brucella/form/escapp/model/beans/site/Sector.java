...
public class Sector {
    ...
    /**
     * Description of the {@link Sector}.
     * Can be empty.
    ...
    /**
     * id of the site to which the {@link Sector} belongs.
     * Can't be null.
     * 
     * @see #getSiteId()
     ...
     * 
     * @return the name of the {@link Sector}.
     * 			Can't be empty.
     ...
     * 
     * @return the description of the {@link Sector}.
     * 			Can be empty.
     * 			Max size is 10 000 characters.
     * 
     * @see #description
     ...
     * 
     * @return {@link Integer} id of the {@link Site} to which the {@link Sector} belongs.
     * 			Can't be null.
     * 
     *  @see #siteId
     *  @see #setSiteId(Integer)
     ...
     * 
     * @param pName the name of the {@link Sector}.
     * 				Can't be empty.
     * 				Max size is 100 characters.
     * 
     * @see #name
     ...
     * 
     * @param pDescription the description of the {@link Sector}. 
     * 					   Can be empty.
     * 					   Max size is 10 000 characters.
     * 
     * @see #description
