...
public class Site {
    ...
    /**
     * String representing the department code to which {@link Site} belongs.
    ...
    /**
     * Municipality to which {@link Site} belongs.
     * Can't be empty and max size is 100 characters.
     * 
     * @see #getMunicipality()
     ...
     * 
     * @return the {@link String} representing the department code to which {@link Site} belongs.
     * 			Can't be empty
     ...
     *  
     * @return the municipality to which {@link Site} belongs.
     * 			Can't be empty.
     * 			Max size is 100 characters.
     * 
     * @see #municipality
     ...
     * 
     * @return the description of the {@link Site}.
     * 			Can be empty.
     * 			Max size is 10 000 characters.
     * 
     * @see #description
     ...
     * 
     * @param pName the name of the {@link Site}.
     * 				Can't be empty.
     * 				Max size is 100 characters.
     * 
     * @see #name
     ...
     * 
     * @param pDepartment the {@link String} representing the department code to which {@link Site} belongs.
     * 					  Can't be empty
     * 					  Size need to be 3 characters.
     * 					  Ex : "034", "030", "02A"
     * 
     ...
     * 
     * @param pMunicipality the municipality to which {@link Site} belongs.
     * 						Can't be empty
     * 						Max size is 100 characters
     * 
     * @see #municipality
     ...
     * 
     * @param pDescription the description of the {@link Site}. 
     * 					   Can be empty.
     * 					   Max size is 10 000 characters.
     * 
     * @see #description
